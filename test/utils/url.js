...
describe('#url', function () {
    ...
    it('should provide parseUrl method', function () {
        ...
        let _url = url.parseUrl('http://localhost:4000/greeting?user=test');
    ...
    it('should provide parseQuery method', function () {
        ...
        let _query = url.parseQuery('foo=bar&abc=xyz&abc=123');
    ...
    it('should provide compile method', function () {
        ...
        let _data = url.compile('/greeting/:category/:page?');
